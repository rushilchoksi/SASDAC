...
$updateUserAccount = $DB_CONNECTION->query("SELECT `ID`, `IV`, `Name`, `Mobile`, `Email`, `Role`, `Active`, `Salt`, `Password` FROM `users`;");
...
if ($validUser == true) {
    if ($userAccount[6] == 1) {
        ...
        $verificationMail->Host = 'smtp.gmail.com';
        $verificationMail->Port = 465;
        $verificationMail->IsHTML(true);
        $verificationMail->Username = 'ibm.project.soc@gmail.com';
        $verificationMail->Password = 'mdktbxgxcslyrzno';
        $verificationMail->From = 'ibm.project.soc@gmail.com';
